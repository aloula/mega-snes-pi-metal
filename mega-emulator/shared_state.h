...
struct SharedState {
    ...
    volatile u64 last_input_time __attribute__((aligned(64)));
    volatile boolean screensaver_active __attribute__((aligned(64)));
    ...
    // Double-buffered emulator frame buffer (320x320, RGB565) to support full PAL + overscan start lines
    u16 emu_frame_buffer[2][320 * 320] __attribute__((aligned(64)));
