    ...
    while (1) {
        ...
        if (g_SharedState.in_menu) {
            ...
            if (g_SharedState.menu_needs_redraw) {
                ...
                if (num_lines == 0) {
                    if (active_tab == 1) {
                        DrawString(pBackBuffer, SCREEN_WIDTH, "No favorites added! Press B on a game to favorite it.", 116, 180, COLOR15(22, 24, 26), 0);
                    } else {
            ...
            if (g_SharedState.video_frame_ready) {
                ...
                if (game_h <= 0) game_h = 224;

                static u16 scanline_buf[640];
